...
const long  gmtOffset_sec = -3 * 3600;             // time zone * 3600 , Brazil time zone is -3 GMT
...
uint32_t volt = (analogRead(35) * 2 * 3.3 * 1000) / 4096; // Update pin to 35 for battery voltage
