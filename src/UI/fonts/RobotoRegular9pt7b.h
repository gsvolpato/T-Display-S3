const uint8_t Roboto_Regular9pt7b_Bitmaps[] PROGMEM = {
...
const GFXglyph Roboto_Regular9pt7b_Glyphs[] PROGMEM = {
  {     0,   1,   1,   4,    0,    0 },   // 0x20 ' '
  {     1,   2,  13,   5,    1,  -12 },   // 0x21 '!'
  {     5,   4,   4,   6,    1,  -13 },   // 0x22 '"'
...
const GFXfont Roboto_Regular9pt7b_ PROGMEM = {
  (uint8_t  *)Roboto_Regular9pt7b_Bitmaps,
  (GFXglyph *)Roboto_Regular9pt7b_Glyphs,
  0x20, 0x7E, 21 };
